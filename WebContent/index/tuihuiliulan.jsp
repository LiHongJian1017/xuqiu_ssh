		...
		<div class="row-fluid">
			...
			<div class="col-md-10 ">
				...
				<tr>
					...
					<td>
					<a href="${pageContext.request.contextPath}/xuqiu_tuihuineeddelete.action?id=${item.id }&userid=${user.id}">
					<button type="button" class="btn btn-primary">删除</button></a></td>
					<td>
					<a href="${pageContext.request.contextPath}/xuqiu_tuihuiliulandetail?id=${item.id }">
