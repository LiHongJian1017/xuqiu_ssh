...
<link type="text/css" rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/ui-base.css">
...
<body style="background-color:#dceefc">
	...
	<hr>
	<center>
	<form action="${pageContext.request.contextPath}/xuqiu_zhengjishenehe.action?id=${zhengjibean.id }" method="post">
		<table border="1px" width="860px" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
			...
			<br>
			<br>
		<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">退回</button>&nbsp;&nbsp;&nbsp;
		<button type="submit" class="btn btn-primary">通过</button>&nbsp;&nbsp;&nbsp;
		<a href="${pageContext.request.contextPath}/xuqiu_shenhe?status=1"><button type="button" class="btn btn-primary">返回</button></a>
	</form>
	</center>
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">请填写退回理由</h4>
					</div>
					<div class="modal-body">
						<form
							action="${pageContext.request.contextPath}/xuqiu_zhengjituihui.action?id=${zhengjibean.id }"
							method="post">
							<div class="form-group">
								<textarea  class="form-control" name="tuihui" rows="8" cols="120"
									style="border: 0" maxlength="500"
