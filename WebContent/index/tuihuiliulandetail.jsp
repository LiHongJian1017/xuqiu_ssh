...
<body style="background-color:#dceefc">
	...
	<hr>
	<center>
	<form action="${pageContext.request.contextPath}/xuqiu_tuihuiliulan.action?status=4&userid=${user.id}"" method="post">
		<table border="1px" width="860px" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
			...
			<tr height="40px">
					<td colspan="4" style="height: 150px;text-align:center"><font style="color:red">*</font>退回理由</td>
					<td colspan="8" style="height: 150px">${tuihuibean.tuihui}
					</td>
			</tr>
			</table>
		<br><br>
