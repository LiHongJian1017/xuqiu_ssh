...
<script type="text/javascript">
 ...
 <script language="javascript">
	function checkinfo(){
		...
		var jiname=$("#jiname").val();//1
		var tongxundizhi=$("#tongxundizhi").val();//2
		var suozaidiyu=$("#suozaidiyu").val();//3
		var dianzixinxiang=$("#dianzixinxiang").val();//4
		var farendaibiao=$("#farendaibiao").val();//5
		var lianxi=$("#lianxi").val();//6
		var dianhua=$("#dianhua").val();//7
		var shouji=$("#shouji").val();//8
		var jigoujianjie=$("#jigoujianjie").val();//9
		var xuqiuqianyear=$("#xuqiuqianyear").val();//10
		var xuqiuhouyear=$("#xuqiuhouyear").val();//11
		var xuqiugaishu=$("#xuqiugaishu").val();//12
		var guanjian1=$("#guanjian1").val();//13
		var guanjian2=$("#guanjian2").val();//14
		var guanjian3=$("#guanjian3").val();//15
		var guanjian4=$("#guanjian4").val();//16
		var guanjian5=$("#guanjian5").val();//17
		
		if(guanjian5==""){id=1; num++;}
		if(guanjian4==""){id=2; num++;}
		if(guanjian3==""){id=3; num++;}
		if(guanjian2==""){id=4; num++;}
		if(guanjian1==""){id=5; num++;}
		if(xuqiugaishu==""){id=6; num++;}
		if(xuqiuhouyear==""){id=7; num++;}
		if(xuqiuqianyear==""){id=8; num++;}
		if(jigoujianjie==""){id=9; num++;}
		if(shouji==""){id=10; num++;}
		if(dianhua==""){id=11; num++;}
		if(lianxi==""){id=12; num++;}
		if(farendaibiao==""){id=13; num++;}
		if(dianzixinxiang==""){id=14; num++;}
		if(suozaidiyu==""){id=15; num++;}
		if(tongxundizhi==""){id=16; num++;}
		if(jiname==""){id=17; num++;}
		...
		var kejihuodongleixing=document.getElementsByName("kejihuodongleixing");
		var jigoushuxing=document.getElementsByName("jigoushuxing");
		var xuqiujiejuefangshi=document.getElementsByName("xuqiujiejuefangshi");
		for(var i=0;i<kejihuodongleixing.length;i++)
	    {
	        if(kejihuodongleixing[i].checked)
	        {
	            yi=1;
	        }
	    }
		for(var i=0;i<jigoushuxing.length;i++)
	    {
	        if(jigoushuxing[i].checked)
	        {
	            er=1;
	        }
	    }
		for(var i=0;i<xuqiujiejuefangshi.length;i++)
	    {
	        if(xuqiujiejuefangshi[i].checked)
	        {
	            san=1;
	        }
	    }
		...
		if(num!=0)
			{
			document.getElementById('jiname').focus();
			var txt=  "有"+num+"个必选项未填！！！";
...
<body style="background-color:#dceefc" onload= "javascript:document.getElementById( 'jiname').focus();">
	...
	<hr>
	<center>
	<form  id="form" action="${pageContext.request.contextPath}/xuqiu_addneed.action?userid=${user.id }" method="post">
		<table border="1px" width="80%" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
			...
			<tr height="40px">
				...
				<td colspan="3"><input onkeypress="return handleEnter(this, event)"  type="text" id="suozaidiyu" name="suozaidiyu" style="border:0;width:220px;;height:30px" value="${user.shi }" maxlength="30"></td>
			</tr>
			<tr height="40px">
				...
				<td colspan="3"><input onkeypress="return handleEnter(this, event)" type="text" id="dianzixinxiang" name="dianzixinxiang" style="border:0;width:220px;;height:30px" value="${user.youxiang}"></td>
			</tr>
			<tr height="40px">
				<td colspan="4" style=text-align:center><font style="color:red">*</font>法人代表</td>
				<td colspan="5"><input onkeypress="return handleEnter(this, event)"  type="text" id="farendaibiao" name="farendaibiao" style="border:0;width:270px;;height:30px" value="" maxlength="30"></td>
			...
			<tr height="40px">
				...
				<td rowspan="2" colspan="3" ><input onkeypress="return handleEnter(this, event)" type="text" id="lianxi" name="lianxi" style="border:0;width:220px;;height:30px" value="${user.name }"></td>
				<td colspan="2" style=text-align:center><font style="color:red">*</font>电话</td>
				<td colspan="3">
					1.固定:<input onkeypress="return handleEnter(this, event)" type="text"  id="dianhua" name="dianhua" style="border:0;width:140px;height:30px" value="${user.dianhua }">
					2.手机:<input onkeypress="return handleEnter(this, event)" type="text"  id="shouji" name="shouji" style="border:0;width:140px;height:30px" value="${user.shouji }">
				</td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="3"><input onkeypress="return handleEnter(this, event)" type="text"  id="chuangzhen" name="chuangzhen" style="border:0;width:220px;;height:30px" value=""></td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="8">
					...
					<input onkeypress="return handleEnter(this, event)" type="radio"  id="jigoushuxing" name="jigoushuxing" id="qi" value="企业">企业
					<input onkeypress="return handleEnter(this, event)" type="radio" id="jigoushuxing"  name="jigoushuxing" id="xiao" value="高等院校">高等院校
					<input onkeypress="return handleEnter(this, event)" type="radio" id="jigoushuxing" name="jigoushuxing" id="yan" value="研究机构">研究机构
					<input onkeypress="return handleEnter(this, event)" type="radio" id="jigoushuxing" name="jigoushuxing" id="ta" value="其他">其他
				</td>
			</tr>
				...
				<tr>
					<td colspan="12" style="height: 150px">
						<textarea  onkeypress="return handleEnter(this, event)" id="jigoujianjie" name="jigoujianjie" rows="8" cols="150" style="border:0" maxlength="500" 
			...
			<tr height="40px">
				...
				<td colspan="3"><input onkeypress="return handleEnter(this, event)" type="text" name="jishuxuqiuname" id="jishuxuqiuname" style="border:0;width:220px;;height:30px"></td>
				...
				<tr height="40px">
					<td colspan="12" style="height: 150px">
						<textarea onkeypress="return handleEnter(this, event)"  id="jishuxuqiuname" name="jishuxuqiuname" rows="8" cols="120" style="border:0" maxlength="500" 
							onchange="this.value=this.value.substring(0, 500)" 
							onkeydown="this.value=this.value.substring(0, 500)" 
							onkeyup="this.value=this.value.substring(0, 500)"></textarea>
					</td>
			...
			<tr height="40px">
				...
				<td colspan="8">
				<input onkeypress="return handleEnter(this, event)" type="text" style="border:1px;width:123px;height:30px" id="guanjian1" name="guanjian1">&nbsp;
				<input onkeypress="return handleEnter(this, event)"  type="text" style="border:1px;width:123px;height:30px" id="guanjian2" name="guanjian2">&nbsp;
				<input onkeypress="return handleEnter(this, event)" type="text" style="border:1px;width:123px;height:30px" id="guanjian3" name="guanjian3">&nbsp;
				<input onkeypress="return handleEnter(this, event)" type="text" style="border:1px;width:123px;height:30px" id="guanjian4" name="guanjian4">&nbsp;
				<input onkeypress="return handleEnter(this, event)" type="text" style="border:1px;width:123px;height:30px" id="guanjian5" name="guanjian5">
				</td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="8">
					<input onkeypress="return handleEnter(this, event)" type="radio" id="xuqiujiejuefangshi" name="xuqiujiejuefangshi" value="独立开发">独立开发&nbsp;
					<input onkeypress="return handleEnter(this, event)" type="radio" id="xuqiujiejuefangshi" name="xuqiujiejuefangshi" value="委托研发">委托研发&nbsp;
					<input onkeypress="return handleEnter(this, event)" type="radio" id="xuqiujiejuefangshi" name="xuqiujiejuefangshi" value="技术入股">合作研发&nbsp;
					<input onkeypress="return handleEnter(this, event)" type="radio" id="xuqiujiejuefangshi" name="xuqiujiejuefangshi" value="合作开发">其他
				</td>
			</tr>
			...
			<table id="xueke" border="1px" width="80%" cellpadding="0" cellspacing="0" style="display:none;border-collapse:collapse">

				<tr height="40px">
					<td  style=text-align:center;width:146px><strong>学科分类</strong></td>
					<td style=border:0;width:180px>
						<select style=height:30px id="xuekenfenlei" name="xuekenfenlei" class="form-control"
			...
			<table style="display:none;border-collapse:collapse" width="80%" id="lingyu" border="1px" cellpadding="0" cellspacing="0">
			<tr height="60px">
		...
		<!--  <button type="submit"  class="btn btn-primary" >保存并提交</button>-->
				<button type="button" class="btn btn-primary"  onclick='checkinfo()' style="width:150px;height:40px;font-size: 20px;font-weight: bold；font-color=blue" >保存并提交</button> 
