...
<body style="background-color:#dceefc" onload= "javascript:document.getElementById( 'jiname').focus();">
	...
	<hr>
	<center>
	<form action="${pageContext.request.contextPath}/xuqiu_needxiugai.action?id=${zhengjibean.id }&userid=${zhengjibean.userid}" method="post">
		<table border="1px" width="860px" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
			...
			<tr height="40px">
				...
				<td colspan="5"><input id="jiname" type="text"  name="jiname" style="border:0;width:270px;height:30px"value="${zhengjibean.jiname }" maxlength="30"/></td>
				<td width="150px" style=text-align:center>归口管理部门</td>
				<td colspan="3"><input  height="40px" type="text" name="guikou" style="border:0;width:220px;;height:30px" value="${zhengjibean.guikou}" maxlength="30"></td>
			</tr>
			<tr height="40px">
				<td colspan="4" style=text-align:center><font style="color:red">*</font>通讯地址</td>
				<td colspan="5"><input  id="tongxundizhi" type="text" name="tongxundizhi" style="border:0;width:270px;;height:30px" value="${zhengjibean.tongxundizhi }" maxlength="30"></td>
				<td width="150px" style=text-align:center><font style="color:red">*</font>所在地域</td>
				<td colspan="3"><input  type="text" name="suozaidiyu" style="border:0;width:220px;;height:30px" value="${zhengjibean.suozaidiyu }" maxlength="30"></td>
			</tr>
			<tr height="40px">
				<td colspan="4" style=text-align:center>网址</td>
				<td colspan="5"><input type="text" name="wangzhi" style="border:0;width:270px;;height:30px" value="${zhengjibean.wangzhi }"></td>
				<td width="150px" style=text-align:center><font style="color:red">*</font>电子信箱</td>
				<td colspan="3"><input type="text"  name="dianzixinxiang" style="border:0;width:220px;;height:30px" value="${zhengjibean.dianzixinxiang }"></td>
			</tr>
			<tr height="40px">
				<td colspan="4" style=text-align:center><font style="color:red">*</font>法人代表</td>
				<td colspan="5"><input   type="text" name="farendaibiao" style="border:0;width:270px;;height:30px" value="${zhengjibean.farendaibiao }" maxlength="30"></td>
				<td width="150px" style=text-align:center>邮政编码</td>
				<td colspan="3"><input  type="text" name="youzhengbianma" style="border:0;width:220px;;height:30px" value="${zhengjibean.youzhengbianma }"></td>
			</tr>
			
			<tr height="40px">
				<td rowspan="2" colspan="4" style=text-align:center> <font style="color:red">*</font>联系人</td>
				<td rowspan="2" colspan="3" ><input type="text" name="lianxi" style="border:0;width:220px;;height:30px" value="${zhengjibean.lianxi }"></td>
				<td colspan="2" style=text-align:center><font style="color:red">*</font>电话</td>
				<td colspan="3">
					1.固定:<input type="text"  name="dianhua" style="border:0;width:140px;height:30px" value="${zhengjibean.dianhua }">
					2.手机:<input type="text" name="shouji" style="border:0;width:140px;height:30px" value="${zhengjibean.shouji }">
				</td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="3"><input type="text" name="chuangzhen" style="border:0;width:220px;;height:30px" value="${zhengjibean.chuangzhen }"></td>
			</tr>
			...
			<tr height="40px">
				...
				<tr>
					<td colspan="12" style="height: 150px">
						<textarea name="jigoujianjie"rows="8" cols="120" style="border:0" maxlength="500" 
							onchange="this.value=this.value.substring(0, 500)" 
							onkeydown="this.value=this.value.substring(0, 500)" 
							onkeyup="this.value=this.value.substring(0, 500)" >${zhengjibean.jigoujianjie}</textarea>
					</td>
				</tr>
			...
			<tr height="40px">
				...
				<td colspan="3"><input type="text" name="jishuxuqiuname" value="${zhengjibean.jishuxuqiuname}" style="border:0;width:220px;;height:30px"></td>
				<td colspan="2"><strong><font style="color:red">*</font>需求时限<strong></td>
				<td colspan="3"><input  id="time" value="${zhengjibean.xuqiuqianyear}"  placeholder="选择时间" onClick="return Calendar('time');" type="text" name="xuqiuqianyear"style="border:0;height:30px">年至
					<input type="text"  id="time1" value="${zhengjibean.xuqiuhouyear}"  placeholder="选择时间" onClick="return Calendar('time1');" name="xuqiuhouyear" style="border:0;height:30px">年	
				</td>
			</tr>
				...
				<tr height="40px">
					<td colspan="12" style="height: 150px">
						<textarea name="xuqiugaishu" rows="8" cols="120" style="border:0" maxlength="500" 
							onchange="this.value=this.value.substring(0, 500)" 
							onkeydown="this.value=this.value.substring(0, 500)" 
							onkeyup="this.value=this.value.substring(0, 500)">${zhengjibean.xuqiugaishu}</textarea>
					</td>
				</tr>
			...
			<tr height="40px">
				...
				<td colspan="8">
				<input value="${zhengjibean.guanjian1}" type="text" style="border:1px;width:123px;height:30px" name="guanjian1">&nbsp;
				<input value="${zhengjibean.guanjian2}" type="text" style="border:1px;width:123px;height:30px" name="guanjian2">&nbsp;
				<input value="${zhengjibean.guanjian3}" type="text" style="border:1px;width:123px;height:30px" name="guanjian3">&nbsp;
				<input value="${zhengjibean.guanjian4}" type="text" style="border:1px;width:123px;height:30px" name="guanjian4">&nbsp;
				<input value="${zhengjibean.guanjian5}" type="text" style="border:1px;width:123px;height:30px" name="guanjian5">
				</td>
			</tr>
			
			<tr height="40px">
				<td colspan="4" style=text-align:center><strong>拟投资金额</strong>
				<td colspan="8" ><input value="${zhengjibean.jine}" onkeyup="value=value.replace(/[^\d]/g,'') " ng-pattern="/[^a-zA-Z]/" type="text" name="jine" style="border:0px;width:220px;height:30px">&nbsp;万元</td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="8">
					...
					<input type="radio" name="xuqiujiejuefangshi" value="委托研发"  >委托研发
					<input type="radio" name="xuqiujiejuefangshi" value="技术入股"  >合作研发
					<input type="radio" name="xuqiujiejuefangshi" value="合作开发" >其他
					</c:if>
					<c:if test="${zhengjibean.xuqiujiejuefangshi.equals('委托研发')}">
					<input type="radio" name="xuqiujiejuefangshi" value="独立开发"  >独立开发
			...
			<tr height="40px">
				...
				<td colspan="8" >合作意向单位:<input value="${zhengjibean.hezuodanwei}" type="text" name="hezuodanwei" style="border:1px;width:220px;height:30px">(选填)</td>
			</tr>
			...
			<tr height="40px">
				...
				<td colspan="8">
					...
					<input type="radio" name="kejihuodongleixing" id="jishu" value="技术推广与科技服务" >技术推广与科技服务
				...
				<c:if test="${zhengjibean.kejihuodongleixing.equals('应用研究')}">
					<input type="radio" name="kejihuodongleixing" id="jichu" value="基础研究" >基础研究
		...
		<br><br>
		<button type="submit"  class="btn btn-primary" >修改并保存</button>
	</form>
	</center>
