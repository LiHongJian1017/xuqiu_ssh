...
<link rel="stylesheet"type="text/css" href="${pageContext.request.contextPath}/js/static/css/bootstrap.css"/>
</head>
...
<script
	...
	<script
	src="${pageContext.request.contextPath}/js/static/js/bootstrap.js"type="text/javascript"></script>
	<script
